...
import 'package:push_notifications/api_properties.dart';
...
class _Application extends State<Application> {
  ...
  Future<void> sendPushMessage() async {
    ...
    try {
      await dioWithOptionsAndLogger.post(
        fcmGoogleApiLink,
        options: Options(headers: {'Authorization': 'Bearer AIzaSyBvRMzDnOYUg2o9xXA44XwtYMQcXTm4iGY'}),
